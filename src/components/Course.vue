        ...
        <div class="main">
            ...
            <div class="condition">
                <ul class="cate-list">
                    ...
                    <li @click="category=cate.id" :class="category===cate.id?'this':''" v-for="cate in category_list" :key="cate.id">{{ cate.name }}</li>
                </ul>
            ...
            <div class="course-list">
                <div class="course-item" v-for="course in course_list" :key="course.id">
                    ...
                    <div class="course-info">
                        <h3><router-link :to="'/detail/'+course.id">{{ course.name }}</router-link>
                            <span><img src="/static/image/02.png" alt="">{{ course.students }}人已加入学习
                            </span>
                        </h3>
...
export default {
    ...
    methods: {
        ...
        get_category_list(){
            ...
            this.$axios.get(
                this.$settings.HOST + "course/category/"
            ).then(res =>{
        ...
        get_course_list(){
            ...
            // 发送请求
            this.$axios.get(
                this.$settings.HOST + "course/list/",{
                    params: filters
                }
            ).then(res =>{
                console.log(res.data);
